...
new TextEncoder();
const Header = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "absolute top-0 h-6 w-full bg-transparent" });
};
function r(e) {
  var t2, f2, n2 = "";
...
const PazhanLogo = "" + new URL("Pazhan_Logo-bN8eSe0S.png", import.meta.url).href;
const Sidebar = () => {
  const navbarItems = reactExports.useMemo(
    () => [
      {
        label: "Single Tone",
        href: "/single-tone"
  ...
  const [showLogo, setShowLogo] = reactExports.useState(true);
  reactExports.useEffect(() => {
    const checkHeight = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen w-64 shrink-0 flex-col bg-gradient-to-t from-accent-foreground from-10% to-primary px-3 py-5 ring lg:w-64 md:w-56 sm:w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-accent", children: "Noise Generator" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-20 space-y-5", children: navbarItems.map((item, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      NavLink,
      {
        to: item.href,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto", children: showLogo && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto", children: showLogo && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: PazhanLogo,
        alt: "Logo",
...
const createPacket = (method, type, attribute, data) => {
...
const PerformanceIndicator = ({ value, isConnected, onConnectionLost, className, ...props }) => {
  console.log("PerformanceIndicator rendered!");
  reactExports.useEffect(() => {
    console.log("PerformanceIndicator value:", value);
  }, [value]);
  const [isDisconnected, setIsDisconnected] = reactExports.useState(false);
  const lastRequestTime = reactExports.useRef(null);
  const lastResponseTime = reactExports.useRef(null);
  const responseReceived = reactExports.useRef(false);
  const alertShown = reactExports.useRef(false);
  const updatePower = async () => {
    const portInfo = await window.context.serialPort.portInfo();
    if (portInfo) {
      const packet = createPacket("GET", "DPOWER", "TXPOWER", "");
  ...
  reactExports.useEffect(() => {
    ...
    const checkConnection = setInterval(() => {
      if (lastRequestTime.current !== null && lastResponseTime.current !== null) {
        ...
        if (elapsedTimeSinceLastResponse > 1e5) {
        ...
        if (elapsedTimeSinceLastRequest > 1e5) {
          if (!isDisconnected && !alertShown.current) {
            setIsDisconnected(true);
            onConnectionLost();
            alert("Connection lost! No response from device.");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-xl font-bold text-black", children: value })
      ]
    }
  );
};
...
var ft = 1, mt = class {
  constructor() {
    ...
    this.create = (o) => {
      var P2;
      let { message: t2, ...s } = o, g = typeof (o == null ? void 0 : o.id) == "number" || ((P2 = o.id) == null ? void 0 : P2.length) > 0 ? o.id : ft++, l2 = this.toasts.find((h) => h.id === g), E2 = o.dismissible === void 0 ? true : o.dismissible;
      return l2 ? this.toasts = this.toasts.map((h) => h.id === g ? (this.publish({ ...h, ...o, id: g, title: t2 }), { ...h, ...o, id: g, dismissible: E2, title: t2 }) : h) : this.addToast({ title: t2, ...s, dismissible: E2, id: g }), g;
    };
    this.dismiss = (o) => (o || this.toasts.forEach((t2) => {
      this.subscribers.forEach((s) => s({ id: t2.id, dismiss: true }));
    ...
    this.promise = (o, t2) => {
      if (!t2) return;
      let s;
      t2.loading !== void 0 && (s = this.create({ ...t2, promise: o, type: "loading", message: t2.loading, description: typeof t2.description != "function" ? t2.description : void 0 }));
      let g = o instanceof Promise ? o : o(), l2 = s !== void 0, E2, P2 = g.then(async (c) => {
        if (E2 = ["resolve", c], React.isValidElement(c)) l2 = false, this.create({ id: s, type: "default", message: c });
        else if (Qt(c) && !c.ok) {
          l2 = false;
          let k2 = typeof t2.error == "function" ? await t2.error(`HTTP error! status: ${c.status}`) : t2.error, j = typeof t2.description == "function" ? await t2.description(`HTTP error! status: ${c.status}`) : t2.description;
          this.create({ id: s, type: "error", message: k2, description: j });
        } else if (t2.success !== void 0) {
          l2 = false;
          let k2 = typeof t2.success == "function" ? await t2.success(c) : t2.success, j = typeof t2.description == "function" ? await t2.description(c) : t2.description;
          this.create({ id: s, type: "success", message: k2, description: j });
        }
      }).catch(async (c) => {
        if (E2 = ["reject", c], t2.error !== void 0) {
          ...
          this.create({ id: s, type: "error", message: y2, description: k2 });
        }
      }).finally(() => {
        var c;
        l2 && (this.dismiss(s), s = void 0), (c = t2.finally) == null || c.call(t2);
    ...
    this.custom = (o, t2) => {
      let s = (t2 == null ? void 0 : t2.id) || ft++;
      return this.create({ jsx: o(s), id: s, ...t2 }), s;
    };
    this.subscribers = [], this.toasts = [];
  }
}, T = new mt(), Gt = (r2, o) => {
  let t2 = (o == null ? void 0 : o.id) || ft++;
  return T.addToast({ title: r2, ...o, id: t2 }), t2;
...
function pt(r2, { insertAt: o } = {}) {
  if (typeof document == "undefined") return;
  let t2 = document.head || document.getElementsByTagName("head")[0], s = document.createElement("style");
  s.type = "text/css", o === "top" && t2.firstChild ? t2.insertBefore(s, t2.firstChild) : t2.appendChild(s), s.styleSheet ? s.styleSheet.cssText = r2 : s.appendChild(document.createTextNode(r2));
}
...
var ce = (r2) => {
  ...
  return React.createElement("li", { tabIndex: 0, ref: H2, className: R2(J2, jt, a == null ? void 0 : a.toast, (xt = t2 == null ? void 0 : t2.classNames) == null ? void 0 : xt.toast, a == null ? void 0 : a.default, a == null ? void 0 : a[x2], (vt = t2 == null ? void 0 : t2.classNames) == null ? void 0 : vt[x2]), "data-sonner-toast": "", "data-rich-colors": (wt = t2.richColors) != null ? wt : j, "data-styled": !(t2.jsx || t2.unstyled || s), "data-mounted": B2, "data-promise": !!t2.promise, "data-swiped": Y2, "data-removed": U2, "data-visible": ot, "data-y-position": ht, "data-x-position": $t, "data-index": h, "data-front": et, "data-swiping": M2, "data-dismissible": F2, "data-type": x2, "data-invert": Wt, "data-swipe-out": Z2, "data-expanded": !!(y2 || C2 && B2), style: { "--index": h, "--toasts-before": h, "--z-index": c.length - h, "--offset": `${U2 ? d : $.current}px`, "--initial-height": C2 ? "auto" : `${b}px`, ...st, ...t2.style }, onPointerDown: (n2) => {
...
var Be = reactExports.forwardRef(function(o, t2) {
  ...
  return React.useEffect(() => T.subscribe((d) => {
    ...
    return C2.length ? React.createElement("ol", { key: d, dir: K2 === "auto" ? zt() : K2, tabIndex: -1, ref: A2, className: h, "data-sonner-toaster": true, "data-theme": dt, "data-y-position": b, "data-lifted": R2 && C2.length > 1 && !E2, "data-x-position": w2, style: { "--front-toast-height": `${((D2 = G2[0]) == null ? void 0 : D2.height) || 0}px`, "--offset": typeof c == "number" ? `${c}px` : c || ne, "--width": `${se}px`, "--gap": `${J2}px`, ...O2 }, onBlur: (f2) => {
      ...
      var et, ot;
      return React.createElement(ce, { key: f2.id, icons: _, index: H2, toast: f2, defaultRichColors: k2, duration: (et = i == null ? void 0 : i.duration) != null ? et : j, className: i == null ? void 0 : i.className, descriptionClassName: i == null ? void 0 : i.descriptionClassName, invert: s, visibleToasts: st, closeButton: (ot = i == null ? void 0 : i.closeButton) != null ? ot : P2, interacting: q2, position: d, style: i == null ? void 0 : i.style, unstyled: i == null ? void 0 : i.unstyled, classNames: i == null ? void 0 : i.classNames, cancelButtonStyle: i == null ? void 0 : i.cancelButtonStyle, actionButtonStyle: i == null ? void 0 : i.actionButtonStyle, removeToast: tt, toasts: C2.filter((x2) => x2.position == f2.position), heights: G2.filter((x2) => x2.position == f2.position), setHeights: Q2, expandByDefault: E2, gap: J2, loadingIcon: rt, expanded: R2, pauseWhenPageIsHidden: lt, cn: X2 });
    })) : null;
  }));
});
/**
...
const useDeviceSettings = create(
  persist(
    (set, get) => ({
      data: initial,
      ...
      onInvalid: () => {
        ...
        set({
          data: history[0],
          // مقدار اینپوت‌ها را به مقدار سالم برگردان
          history: [history[0], history[0]]
          // مقدار `history[1]` نیز اصلاح شود
        });
      },
...
const sleep = (timeout) => new Promise((res) => setTimeout(() => res("resolved"), timeout));
const ExitButton = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "destructive", className: "mt-auto w-full", onClick: window.context.app.exit, children: "Exit" });
};
const DeviceStatus = () => {
  ...
  const [listStatus, setListStatus] = reactExports.useState("loading");
  const [ports, setPorts] = reactExports.useState([]);
  const [selectedPort, setSelectedPort] = reactExports.useState(null);
  ...
  const connectToPort = async () => {
    ...
    try {
      ...
      te(`Connected to port ${selectedPort}`, {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "text-green-600" })
      });
    } catch (error) {
      console.error("Error connecting to port:", error);
      setConnectionStatus("error");
      te("Connecting to port failed", {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "text-red-600" })
      });
    }
  };
  const getAllPorts = async () => {
    te("Load all ports", {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "animate-spin text-blue-600 duration-1000" }),
      id: "get-ports"
    });
    try {
      ...
      await sleep(1e3);
      te("Ports loaded successfully", {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "text-green-600" }),
        id: "get-ports"
      });
    } catch {
      setListStatus("failure");
      te("Load all ports failed", {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "text-red-600" }),
        id: "get-ports"
      });
    }
  ...
  const disconnect = () => {
    ...
    te("Port Disconnected", {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Unplug, { className: "text-red-600" })
    });
  };
  ...
  const handleResponse = (chunk) => {
    ...
    if (parsedResponse) {
      ...
      switch (parsedResponse.method) {
        case "SET": {
          switch (parsedResponse.data.toLowerCase()) {
            ...
            default:
              setTimeout(() => {
                te(`Error in ${fieldName}: ${parsedResponse.data}`, {
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "text-red-600" })
                });
      ...
      console.error("Failed to parse response:", chunk);
    }
  };
  reactExports.useEffect(() => {
    getAllPorts();
  ...
  const renderStatusBadge = () => {
    switch (connectionStatus) {
      case "loading":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: "Connecting..." });
      case "connected":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "default", children: "Connected" });
      case "error":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", children: "Connection Failed" });
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: "Disconnected" });
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-screen w-72 shrink-0 p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col overflow-y-auto rounded-lg bg-card px-3 py-5 shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-5 border-b border-border pb-2 text-lg font-semibold text-accent-foreground", children: "Connection Info" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Port:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: selectedPort || "none" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Baundrate:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: "115200 " })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: connectionStatus === "loading" ? "Connecting" : connectionStatus === "connected" ? "Disconnect" : "Connect"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-x-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", disabled: connectionStatus === "connected", onClick: getAllPorts, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            disabled: connectionStatus === "connected",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { disabled: true, selected: true, children: "select port" }),
              ports.map((port, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: port.path, children: port.path }, index2))
            ]
          }
        )
      ] })
    ...
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0 space-y-5 text-center text-sm text-muted-foreground", children: "Output Power (dbm)" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ExitButton, {})
  ] }) });
};
...
const CardTitle = reactExports.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: cn("text-2xl font-semibold leading-none tracking-tight", className), ...props })
);
...
const Slider = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Root$5,
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Track, { className: "relative h-2 w-full grow overflow-hidden rounded-full bg-secondary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Thumb$1, { className: "block h-5 w-5 rounded-full border-2 border-primary bg-background ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Thumb$1, { className: "block h-5 w-5 rounded-full border-2 border-primary bg-background ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50" })
    ]
  }
));
Slider.displayName = Root$5.displayName;
const calculateDecimal = (selectedFrequencies) => {
...
const decimalToBinaryArray = (decimalNumber) => {
...
const Frequency = () => {
  ...
  const [sliderValue, setSliderValue] = reactExports.useState(0);
  const countSelectedTones = (mSelect) => {
  ...
  const MAX_TXATTEN = 65;
  const [localTXATTEN, setLocalTXATTEN] = reactExports.useState(() => {
    const initialMinFrequency = getMinFrequency();
    let initialTXATTEN = initialMinFrequency;
    if (location.pathname === "/filtered-noise" && data.FNOISE.NOISEBW === 56e6) {
      initialTXATTEN = 11;
    }
    console.log(
  ...
  const sliderToTXATTEN = (sliderVal, _minVal, maxVal) => {
    return maxVal - sliderVal;
  };
  const txattenToSlider = (txatten, _minVal, maxVal) => {
    return maxVal - txatten;
  };
  const calculateFillPercentage = (value, minValue, maxValue) => {
    const percentage = (value - minValue) / (maxValue - minValue) * 100;
    return `${percentage}%`;
  };
  const [isFrequencyValid, setIsFrequencyValid] = reactExports.useState(true);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    ...
    setIsFrequencyValid(freq >= 15e7 && freq <= 55e8);
  }, [data.LOFATT.LOFRQCY]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "RF Settings" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70", children: "Power Level" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500", children: "Max" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Slider,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70", children: "Frequency (Hz)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "number",
...
function wrapArray(array, startIndex2) {
  return array.map((_, index2) => array[(startIndex2 + index2) % array.length]);
}
...
const Toggle = reactExports.forwardRef(({ className, variant, size: size2, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(Root$2, { ref, className: cn(toggleVariants({ variant, size: size2, className })), ...props }));
Toggle.displayName = Root$2.displayName;
const ToggleGroupContext = reactExports.createContext({
  size: "default",
  variant: "default"
});
const ToggleGroup = reactExports.forwardRef(({ className, variant, size: size2, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(Root2, { ref, className: cn("flex items-center justify-center gap-1", className), ...props, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleGroupContext.Provider, { value: { variant, size: size2 }, children }) }));
...
const SelectMode = () => {
  const { data, onChange } = useDeviceSettings();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Output" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ToggleGroup,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleGroupItem, { value: "0", className: "data-[state=on]:bg-primary data-[state=on]:text-accent", children: "None" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleGroupItem, { value: "1", className: "data-[state=on]:bg-primary data-[state=on]:text-accent", children: "CW" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleGroupItem, { value: "2", className: "px-0 data-[state=on]:bg-primary data-[state=on]:text-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { className: "size-full px-3", children: "Pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(PopoverContent, { className: "flex w-fit items-center gap-x-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "On Time (us)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    type: "number",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Off Time (us)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleGroupItem, { value: "3", className: "px-0 data-[state=on]:bg-primary data-[state=on]:text-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { className: "size-full px-3", children: "Random Pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(PopoverContent, { className: "flex w-fit items-center gap-x-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "On Time (us)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const getActiveSignals = (decimalValue) => {
  if (decimalValue === void 0) return "No data";
...
const AnalyticsReport = ({ pageType }) => {
  const { data, history } = useDeviceSettings();
  useLocation();
  const savedData = history[1];
  reactExports.useEffect(() => {
  ...
  switch (pageType) {
    case "single":
      pageSpecificContent = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Single Tone :" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Frequency:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.SINGLE?.FREQCY0 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "PowerLevel:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.SINGLE?.ATTENV0 })
      ] }) });
      break;
    case "multi":
      pageSpecificContent = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Multi-Tone :" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Signals select:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: getActiveSignals(savedData.MULTON?.MSELECT) })
        ] }),
        Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-small text-black", children: [
            "Frequency ",
            i + 1,
            ":"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.MULTON?.[`FREQCY${i}`] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Level:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.MULTON?.[`ATTENV${i}`] })
        ] }, i))
      ] }) });
      break;
    case "sweep":
      pageSpecificContent = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Sweep :" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Min frequency:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.SWEEPF?.MINFREQ }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Max frequency:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.SWEEPF?.MAXFREQ }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Step:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.SWEEPF?.STPFREQ }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Level:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.SWEEPF?.ATTENVL }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Reverse:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.SWEEPF?.REVERSE }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Time(S):" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.SWEEPF?.SWPTIME })
      ] }) });
      break;
    case "barrage":
      pageSpecificContent = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "barrage :" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Number of carries:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.BARAGE?.BNUMBER })
      ] }) });
      break;
    case "filtered":
      pageSpecificContent = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Filtered Noise :" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Bandwidth:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.FNOISE?.NOISEBW }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Center Frequency:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.FNOISE?.SHFFREQ }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Enable shift:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.FNOISE?.SHFENBL })
      ] }) });
      break;
    case "doppler":
      pageSpecificContent = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Delay Doppler :" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Enable delay:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.DELDOP?.DELAYEN }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Enable doppler shift:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.DELDOP?.DOPLREN }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Delay:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.DELDOP?.DLYVALU }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "Doppler:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.DELDOP?.DOPFREQ })
      ] }) });
      break;
    default:
      pageSpecificContent = /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No specific data for this page." });
  }
  const getSignalType = () => {
    const noisess = data.NOISES.NOISESS ?? 0;
    console.log("NOISESS value in getSignalType (from data):", noisess);
    return signalEnum[noisess] || "Unknown";
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Analytics Report" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Signal:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: getSignalType() })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Frequency Value:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.LOFATT?.LOFRQCY })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Mode:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: modeEnum[savedData.NOISES?.PSGMODE] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "pulse(on time):" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.NOISES?.ONDETER }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "pulse(off time):" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.NOISES?.OFFDETR }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "R.pulse(on time)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.NOISES?.ONSTOCH }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-small text-black", children: "R.pulse(off time)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: savedData.NOISES?.OFFSTOC })
        ] })
      ] }),
      pageSpecificContent
    ] }),
...
const Layout = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen max-h-screen w-full space-y-5 overflow-y-auto p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold", children: " Settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-10 xl:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Frequency, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectMode, {})
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnalyticsReport, { pageType })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DeviceStatus, {})
  ] });
};
const ActionButtons = ({ values, type, isValid = true }) => {
  const { data, onCancel, onReset, onSubmit } = useDeviceSettings();
  reactExports.useState(data.NOISES.PSGMODE);
  const handleSubmit = async () => {
    if (!isValid) {
      te("Error: Fmin value must be less than or equal to Fmax!", {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "text-red-600" })
      });
      return;
    }
    const MAX_SWEEP_TIME = 9999999;
    const sweepTimeMs = data.SWEEPF.SWPTIME !== void 0 ? data.SWEEPF.SWPTIME * 1e3 : void 0;
    const isSweepTimeValid = sweepTimeMs !== void 0 && sweepTimeMs >= 1e-5 && sweepTimeMs <= MAX_SWEEP_TIME;
    if (!isSweepTimeValid) {
      te("Error: Sweep Time must be between 0.00001 and 9999999 ms!", {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "text-red-600" })
      });
      return;
    }
    ...
    if (!port) {
      te("Port isn't connected", { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Unplug, { className: "text-red-600" }) });
      return;
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid w-full grid-cols-1 gap-5 lg:grid-cols-3 xl:w-1/2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleSubmit, className: "col-span-1 w-full", children: "Submit" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        variant: "destructive",
...
const BarragePage = () => {
  const { data, onChange } = useDeviceSettings();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Barrage " }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "grid grid-cols-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "frequency0", className: "mb-2 text-sm font-semibold", children: "Number of Carriers" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "select",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: 16, children: "16" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: 32, children: "32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: 64, children: "64" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: 128, children: "128" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButtons, { values: { ...data.BARAGE }, type: "BARAGE" }) })
  ] });
};
...
const DelayDopplerPage = () => {
  const { data, onChange } = useDeviceSettings();
  const processPacket2 = (packet) => {
  ...
  reactExports.useEffect(() => {
    if (data.DELDOP) {
      processPacket2(`DELDOP *DELAYEN$$${data.DELDOP.DELAYEN}`);
      processPacket2(`DELDOP *DOPLREN$$${data.DELDOP.DOPLREN}`);
    }
  }, [data.DELDOP.DELAYEN, data.DELDOP.DOPLREN]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Repeater" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "grid grid-cols-1 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-x-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Switch,
          {
            checked: data.DELDOP.DELAYEN === 1,
            onCheckedChange: (checked) => processPacket2(`DELDOP *DELAYEN$$${checked ? 1 : 0}`)
          }
        ),
        "Enable Delay"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-x-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Switch,
          {
            ...
            onCheckedChange: (checked) => processPacket2(`DELDOP *DOPLREN$$${checked ? 1 : 0}`)
          }
        ),
        "Enable Doppler shift"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "Delay (x 100 us)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            value: data.DELDOP.DLYVALU / 100,
            onChange: (e) => onChange({ ...data, DELDOP: { ...data.DELDOP, DLYVALU: +e.target.value * 100 } }),
            ...
            children: [...Array(15).keys()].map((num) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: num + 1, children: num + 1 }, num + 1))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "Doppler (Hz)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "number",
            ...
            onChange: (e) => {
              let value = Math.max(-28e6, Math.min(28e6, Number(e.target.value)));
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButtons, { values: data.DELDOP, type: "DELDOP" }) })
  ] });
};
const FilteredNoisePage = () => {
  const { data, onChange } = useDeviceSettings();
  reactExports.useState(data.FNOISE.SHFENBL === 1);
  reactExports.useEffect(() => {
    if (data.FNOISE) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Filtered Noise" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "grid grid-cols-1 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "Bandwidth" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "select",
        {
          ...
          className: "rounded-md border px-3 py-2 ring ring-transparent focus-within:outline-none focus-within:ring-primary",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: 56e6, children: "56000000" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: 2e7, children: "20000000" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: 8e6, children: "8000000" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: 5e6, children: "5000000" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: 2e6, children: "2000000" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "Center Frequency (Hz)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "number",
            ...
            onChange: (e) => {
              let value = Number(e.target.value);
              value = Math.max(-275e5, Math.min(275e5, value));
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButtons, { values: data.FNOISE, type: "FNOISE" }) })
  ] });
};
...
const Checkbox = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Root,
  {
    ...
    ...props,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Indicator, { className: cn("flex items-center justify-center text-current"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4" }) })
  }
));
...
const MultiTonePage = () => {
  const { data, onChange } = useDeviceSettings();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Multi Tone" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-black-700 text-sm font-medium", children: "Frequency (Hz)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-black-700 text-sm font-medium", children: "Level (0-255)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "invisible text-sm font-medium text-gray-700", children: "Select" }),
      " "
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "grid grid-cols-3 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          type: "number",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButtons, { values: data.MULTON, type: "MULTON" }) })
  ] });
};
const SingleTonePage = () => {
  const { data, onChange } = useDeviceSettings();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Single Tone" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "grid grid-cols-1 gap-5 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "frequency0", className: "mb-2 text-sm font-semibold", children: "Frequency (Hz)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "attenuation0", className: "mb-2 text-sm font-semibold", children: "Level (0-255)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          type: "number",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButtons, { values: data.SINGLE, type: "SINGLE" }) })
  ] });
};
const SweepPage = () => {
  const { data, onChange } = useDeviceSettings();
  const [isValid, setIsValid] = reactExports.useState(true);
  const [isSweepTimeValid, setIsSweepTimeValid] = reactExports.useState(true);
  const [sweepTimeInput, setSweepTimeInput] = reactExports.useState(
    data.SWEEPF.SWPTIME !== void 0 ? (data.SWEEPF.SWPTIME * 1e3).toString() : void 0
  );
  const [displayValue, setDisplayValue] = reactExports.useState(sweepTimeInput);
  const formatNumber = (value) => {
    if (!value) return value;
    const num = parseFloat(value);
    if (isNaN(num)) return value;
    if (num < 1e-3) return value;
    return num.toFixed(5).replace(/\.?0+$/, "");
  };
  const calculateRange = (minFreq, maxFreq, freqStep) => {
  ...
  reactExports.useEffect(() => {
    if (data.SWEEPF) {
      processPacket2(`SWEEPF *REVERSE$$${data.SWEEPF.REVERSE}`);
    }
  }, [data.SWEEPF.REVERSE]);
  reactExports.useEffect(() => {
    setIsValid(data.SWEEPF.MINFREQ <= data.SWEEPF.MAXFREQ);
  }, [data.SWEEPF.MINFREQ, data.SWEEPF.MAXFREQ]);
  const clampValue = (value, min2, max2) => {
    return Math.max(min2, Math.min(max2, value));
  };
  reactExports.useEffect(() => {
    setSweepTimeInput(data.SWEEPF.SWPTIME !== void 0 ? (data.SWEEPF.SWPTIME * 1e3).toString() : "");
    const maxRange = calculateRange(data.SWEEPF.MINFREQ, data.SWEEPF.MAXFREQ, data.SWEEPF.STPFREQ) * 1e3;
    const sweepTimeMs = data.SWEEPF.SWPTIME !== void 0 ? data.SWEEPF.SWPTIME * 1e3 : void 0;
    setIsSweepTimeValid(sweepTimeMs !== void 0 && sweepTimeMs >= 1e-5 && sweepTimeMs <= maxRange);
  ...
  reactExports.useEffect(() => {
    ...
    const MAX_SWEEP_TIME = 9999999;
    if (inputStr === "" || inputStr === void 0) {
      return;
    }
    const inputAsNumber = parseFloat(inputStr);
    let finalValueInSeconds;
    if (isNaN(inputAsNumber) || inputAsNumber < 1e-5 || inputAsNumber > MAX_SWEEP_TIME) {
      setIsSweepTimeValid(false);
      return;
    } else {
      finalValueInSeconds = parseFloat(inputStr) / 1e3;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Sweep" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "grid grid-cols-1 gap-5 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70", children: [
          "F",
          /* @__PURE__ */ jsxRuntimeExports.jsx("sub", { children: "min" }),
          " (Hz)"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            ...
            onChange: (e) => {
              ...
              value = clampValue(value, -28e6, 28e6);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70", children: [
          "F",
          /* @__PURE__ */ jsxRuntimeExports.jsx("sub", { children: "max" }),
          " (Hz)"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70", children: "Step (Hz)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70", children: "Level (0-255)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70", children: "Sweep Time (ms)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "text",
            ...
            onChange: (e) => {
              ...
              setSweepTimeInput(inputValue);
              setDisplayValue(inputValue);
              const MAX_SWEEP_TIME = 9999999;
              const numericValue = inputValue === "" ? void 0 : parseFloat(inputValue);
              const isValid2 = inputValue !== "" && numericValue !== void 0 && !isNaN(numericValue) && numericValue >= 1e-5 && numericValue <= MAX_SWEEP_TIME;
              setIsSweepTimeValid(isValid2);
              if (isValid2 && numericValue !== void 0) {
                const finalValueInSeconds = numericValue / 1e3;
                const finalValueStr = finalValueInSeconds.toFixed(10);
                const limitedValue = parseFloat(finalValueStr.slice(0, 12));
            ...
            onBlur: () => {
              ...
              const MAX_SWEEP_TIME = 9999999;
              if (inputStr === "" || inputStr === void 0) {
                const defaultValue = 1e-5;
                onChange({ ...data, SWEEPF: { ...data.SWEEPF, SWPTIME: defaultValue / 1e3 } });
                setSweepTimeInput(defaultValue.toString());
                setDisplayValue(defaultValue.toString());
                setIsSweepTimeValid(true);
                console.log("onBlur - SWPTIME:", defaultValue / 1e3, "Input:", defaultValue);
                return;
              }
              const inputAsNumber = parseFloat(inputStr);
              const isValid2 = !isNaN(inputAsNumber) && inputAsNumber >= 1e-5 && inputAsNumber <= MAX_SWEEP_TIME;
              if (!isValid2) {
                setIsSweepTimeValid(false);
              } else {
                const finalValueInSeconds = inputAsNumber / 1e3;
                const finalValueStr = finalValueInSeconds.toFixed(10);
                const limitedValue = parseFloat(finalValueStr.slice(0, 12));
                onChange({ ...data, SWEEPF: { ...data.SWEEPF, SWPTIME: limitedValue } });
                const displayStr = formatNumber(inputStr);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButtons, { values: data.SWEEPF, type: "SWEEPF", isValid }) })
  ] });
};
const Router = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/single-tone" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Route, { element: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, {}), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/single-tone", element: /* @__PURE__ */ jsxRuntimeExports.jsx(SingleTonePage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/multi-tone", element: /* @__PURE__ */ jsxRuntimeExports.jsx(MultiTonePage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/sweep", element: /* @__PURE__ */ jsxRuntimeExports.jsx(SweepPage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/barrage", element: /* @__PURE__ */ jsxRuntimeExports.jsx(BarragePage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/filtered-noise", element: /* @__PURE__ */ jsxRuntimeExports.jsx(FilteredNoisePage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/delay-doppler", element: /* @__PURE__ */ jsxRuntimeExports.jsx(DelayDopplerPage, {}) })
    ] })
  ] });
};
function App() {
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(HashRouter, { children: [
